...
<div class="br-mainpanel">
    <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <span class="breadcrumb-item active">ارسال رساله</span>
        </nav>
    </div><!-- br-pageheader -->
    ...
    <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">ارسال رساله </h4>
    </div>
    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper">
            ...
            <form class="" action="{{ route('subscribe.update',$subscriber->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                                @method('PUT')
