...
<div class="br-mainpanel">
    <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <span class="breadcrumb-item active">اضافه خبر جديد</span>
        </nav>
    </div><!-- br-pageheader -->
    ...
    <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">اضافه خبر جديد </h4>
    </div>
            ...
            <form class="" action="{{ route('new.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row mg-b-25">
                    <div class="col-lg">
                        ...
                        <textarea required name="description" cols="80"> تفاصيل الخبر بالعربيه</textarea>
                        <script>
                ...
                <div class="row mg-b-25">
                    ...
                    <div class="col-lg">
                        <label class="custom-file" style="float: right;">
                            <input id="file2" class="custom-file-input" required type="file" name="image">
