            ...
            <div class="br-section-wrapper">
                ...
                <form class="" action="{{ route('realestates.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row mg-b-25">
                        <div class="col-lg">
                            عنوان الاعلان
                            <input class="form-control" placeholder="عنوان الاعلان" type="text" name="title"
                    ...
                    <div class="form-group">
                        <input type="hidden" required class="form-control" name="lat" value="" id="shoplatedi"
                               placeholder="Enter lat ">
                    </div>

                    <div class="form-group">
                        <input type="hidden" required class="form-control" name="lng" value="" id="shoplngedi"
                        ...
                        <div class="col-md-6 col-xs-12">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="autocomplete"
                                       placeholder="{{__('ابحث بالعنوان')}}" review required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mg-b-25">
                        <div class="col-lg">
                            وصف الاعلان
                            <textarea class="form-control" name="details" placeholder="تفاصيل عن الاعلان" rows="8"
                    ...
                    <div class="row mg-b-25">
                        <div class="col-lg">
                            رقم الوتساب
                            <input class="form-control" placeholder="رقم الوتساب" type="text" name="whatsapp_no"
                                   required>
                        </div><!-- col -->
                    </div>
                    ...
                    <div class="row mg-b-25">
                        <div class="col-lg">
                            ملاحظات
                            <textarea class="form-control" name="adminnote" placeholder="" rows="8"
                                      cols="80"></textarea>
                        </div><!-- col -->
