        ...
        <div class="br-section-wrapper">
            ...
            <form class="" action="{{ route('realestates.update',$realEstate->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-xs-12">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="autocomplete" placeholder="{{__('ابحث بالعنوان ')}}" review>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mg-b-25">
                    <div class="col-lg">
                        ملاحظات
                        <textarea class="form-control" name="adminnote" placeholder="" rows="8" cols="80">@if(isset($realEstate->adminnote)){{ $realEstate->adminnote }}@endif</textarea>
                    </div><!-- col -->
                </div>
