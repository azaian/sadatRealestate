...
<div class="br-mainpanel">
    ...
    <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">مناطق الفئات</h4>
    </div>
    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper">
            ...
            <div class="ht-40 justify-content-between">
                <span class="pd-x-15">Add New realestatecategory</span>
                ...
                <table id="slidertable" class="table display responsive nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="" name="">
                                    @foreach ($CategoryDistrict[$onerealestate->id] as $district)
                                    <option value="">{{ ( $district['name'])  }}</option>
                                    @endforeach
                                </select>
                                <a href="{{ route('districts.show',$onerealestate->id) }}" class="btn btn-primary btn-icon rounded-circle mg-r-5">
